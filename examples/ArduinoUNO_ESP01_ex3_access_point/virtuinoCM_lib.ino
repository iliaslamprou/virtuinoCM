/* Example: HC-05 + Arduino UNO (Software Serial Connection) - Access Point
...
//--- SETTINGS ------------------------------------------------
const char* ssid = "ESP01 NETWORK";        // WIFI network SSID
const char* password = "1234567890";       // WIFI network PASSWORD
int port=8000;                             // Virtuino default Server port. Enter this port to Virtuino app
//serverIP = "192.168.4.1";                   This is the default ESP01 access point IP. Enter this IP to Virtuino app
//-------------------------------------------------------------
...
void connectToWiFiNetwork(){
     ...
     while (espSerial.available()) espSerial.read(); // clear ESP01 buffer
